...
ALTER TABLE Project.WAREHOUSES ADD CONSTRAINT users_warehouses_fk
FOREIGN KEY (USER_ID)
...
SELECT P.PRODUCT_ID, P.PRODUCT_NAME, P.DESCRIPTION, W.WAREHOUSE_NAME, PW.QUANTITY
...
SELECT E.EMPLOYEE_ID, FIRST_NAME, E.LAST_NAME, W.WAREHOUSE_NAME
